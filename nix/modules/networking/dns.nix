{
  flake.modules.systemManager.dns =
    {
      pkgs,
      lib,
      nixosModulesPath,
    ...
    let
      ...
      dnscrypt-resolvers = pkgs.fetchFromGitHub {
        ...
        rev = "95c5f82fd4968a9cffaeacced0813223eb15943c"; # follow:branch master
        hash = "sha256-8ATr5f+cdz0GDobnYHayqBjLtIgZSbV7eUfcouQsplM=";
      };
    in
    {
