...
}:
{
  flake.modules.homeManager.linux-desktop =
    let
      theme = "${inputs.dms-plugin-registry}/themes/catppuccin/theme.json";
    in
    {
      imports = [
      ...
      programs.dank-material-shell = {
        ...
        settings = {
          ...
          displayProfiles = {
            niri = {
              profile_1769655383958_zb5r26 = {
                id = "profile_1769655383958_zb5r26";
                name = "home";
                outputSet = [
                  "DP-1"
                  "eDP-1"
                ];
                createdAt = 1769655383958;
                updatedAt = 1769655383958;
              };
            };
          };
          activeDisplayProfile = {
            niri = "profile_1769655383958_zb5r26";
          };
          ...
          barConfigs = [
            {
              ...
              rightWidgets = [
                ...
                {
                  id = "dankActions:variant_1762019076882";
                  enabled = true;
                }
                {
          ...
          desktopClockShowAnalogNumbers = true;
